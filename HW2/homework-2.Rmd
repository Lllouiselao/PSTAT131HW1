...
```{r}
simple_recipe <- recipe(age ~ type+longest_shell+diameter+height+whole_weight+
...
shucked_weight+viscera_weight+shell_weight , data = abalone_train) %>% step_dummy(type+longest_shell+diameter+height+whole_weight+
