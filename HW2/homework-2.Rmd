...
Rmse: is around 2.15, we could conclude this is kind of poor predict since the value > 0.5
Mae: is 1.55 which shows the difference between the prediction and the true value.
Rsq : R^2 shows how well the model fits the data. Since the value is 0.54 we could say it's moderate fits.
